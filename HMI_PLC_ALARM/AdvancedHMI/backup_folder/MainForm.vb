...
Public Class MainForm
    ...
    Private Sub Mqtt_MessageReceived(topic As String, payload As String)
        Me.Invoke(Async Sub()
                      ...
                      If Integer.TryParse(payload, value) Then
                          DF1COM.Write("B3:4/14", value)
                          BasicLabel1.Text = "MQTT Value = " & value

                          Await Task.Delay(200)

                          DF1COM.Write("B3:4/14", 0)

                      Else
                          BasicLabel1.Text = "Invalid MQTT payload: " & payload
                      End If
                  End Sub)
    End Sub
    ...
    Private Async Sub MainForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        BasicLabel2.Text = "MQTT Connected"
    End Sub
